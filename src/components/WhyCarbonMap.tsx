...
const cards = [
  { category: "Market Intelligence", color: "text-primary", tint: "from-primary/10 to-transparent", title: "Full Value Chain Coverage", desc: "The only platform that maps the complete CCS chain — from 30,000+ emitters through capture, transport, hubs to geological storage. No blind spots.", span: "lg:col-span-3", image: europeCcsMap },
  ...
  { category: "Infrastructure", color: "text-stat-orange", tint: "from-stat-orange/10 to-transparent", title: "Transport & Hub Mapping", desc: "115 pipeline corridors and 45+ hubs & terminals classified, mapped and filterable. See how CO₂ flows from source to sink.", span: "lg:col-span-3", image: pipelineNetwork },
  { category: "Analytics", color: "text-stat-pink", tint: "from-stat-pink/10 to-transparent", title: "Emitter Intelligence", desc: "30,000+ industrial CO₂ sources with emission volumes, sector breakdowns, biogenic share, and capturable emissions per facility.", span: "lg:col-span-2", image: emitterHeatmap },
